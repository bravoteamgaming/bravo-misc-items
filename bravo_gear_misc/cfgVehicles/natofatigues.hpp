	...
	{
		hiddenSelectionsTextures[] = {"\A3\Characters_F_Exp\BLUFOR\Data\U_BT_Soldier_AR_F_tna_02_co.paa", "\UK3CB_Factions\addons\UK3CB_Factions_MEC\data\mec_tshirt_brown_03_co.paa"};
	};
	class bravo_combatfatigues_tshirt_mtpd_ws_unit : bravo_combatfatigues_tshirt_base_ws_unit
	{
		hiddenSelectionsTextures[] = {"\lxws\characters_f_lxws\data\NATO\clothing1_desert_CO.paa", "a3\Characters_F_Enoch\Uniforms\Data\I_L_Uniform_01_tshirt_olive_1_co.paa"};
	};
	class bravo_combatfatigues_tshirt_des_ws_unit : bravo_combatfatigues_tshirt_base_ws_unit
	{
		hiddenSelectionsTextures[] = {"\UK3CB_Factions\addons\UK3CB_Factions_ION\data\ion_combat_uniform_des_03_co.paa", "a3\Characters_F_Enoch\Uniforms\Data\I_L_Uniform_01_tshirt_olive_1_co.paa"};
	};
	class bravo_combatfatigues_tshirt_oli_ws_unit : bravo_combatfatigues_tshirt_base_ws_unit
	{
		hiddenSelectionsTextures[] = {"\UK3CB_Factions\addons\UK3CB_Factions_ION\data\ion_combat_uniform_grn_02_co.paa", "\UK3CB_Factions\addons\UK3CB_Factions_MEC\data\mec_tshirt_brown_03_co.paa"};
	};
