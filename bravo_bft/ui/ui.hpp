...
class bravo_bft_moduleDisplay : RscDisplayEmpty
{
	access = 1;
	enableSimulation = 1;
	onLoad = "uiNamespace setVariable ['bravo_bft_displayOpen',true]; 0 spawn bravo_fnc_bftLoadUIData";
	onUnload = "uiNamespace setVariable ['bravo_bft_displayOpen',false]; uiNamespace setVariable ['bravo_bft_currentObject',nil]";
	class controls
	{
		class group : RscControlsGroup
		{
			...
			class controls
			{
				...
				class markerList : RscCombo
				{
					...
					onLoad = "uiNamespace setVariable ['bravo_bft_markerListBox', _this select 0];";
					// onLBSelChanged = "_this call bravo_ttt_fnc_storeListSelected";
					columns[] = {0,0.2,0.9};
				...
				class colourList : RscCombo
				{
					...
					onLoad = "uiNamespace setVariable ['bravo_bft_colourListBox', _this select 0];";
					columns[] = {0,0.2,0.9};
					colorBackground[] = {0,0,0,1};
				...
				{
					onLoad = "uiNamespace setVariable ['bravo_bft_dataNameBox', _this select 0];";
					text = "";
					idc = -1;
					w = 18 * GUI_GRID_CENTER_W;
					h = 1 * GUI_GRID_CENTER_H;
				...
				{
					onButtonClick = "[(ctrlParent (_this select 0)), true] call bravo_fnc_bftComposeData";
					text = "Delete data";
					idc = -1;
				...
				{
					onButtonClick = "[(ctrlParent (_this select 0)), false] call bravo_fnc_bftComposeData";
					text = "Set data";
					idc = -1;
				...
				{
					onLoad = "uiNamespace setVariable ['bravo_bft_classnameBox', _this select 0];";
					idc = -1;
					w = 19 * GUI_GRID_CENTER_W;
					h = 2.5 * GUI_GRID_CENTER_H;
					x = 0.5 * GUI_GRID_CENTER_W;
