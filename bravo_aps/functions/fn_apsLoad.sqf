...
playSound3D ["A3\Sounds_F\arsenal\weapons\LongRangeRifles\DMR_01_Rahim\DMR_01_reload.wss",_target];
["APS READY",2,0] remoteExec ["bravo_fnc_apsLocalWarning", _crew];
