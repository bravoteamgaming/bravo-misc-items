class CfgPatches
{
	class bravo_munitions
	{
		...
		requiredAddons[] = {"A3_Data_F_Decade_Loadorder", "UK3CB_BAF_Weapons_Ammo", "rhs_main_loadorder", "rf_data_loadorder", "rhsusf_main_loadorder", "gm_weapons_launchers_strela", "gm_weapons_launchers_fim43", "UK3CB_Factions_Weapons2"};
		units[] = {
