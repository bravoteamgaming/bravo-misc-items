...
class bravo_muzzleslot_762_long : asdg_MuzzleSlot_762
{
...
class bravo_muzzleslot_556_long : asdg_MuzzleSlot_556
{
	class CompatibleItems : CompatibleItems
	{
...
{	
	...
	class gm_hk33_base : gm_rifle_base
	{
		class WeaponSlotsInfo : WeaponSlotsInfo
		{
			class MuzzleSlot : bravo_MuzzleSlot_556_long
			{};
		};
	};
	...
	class gm_g3_base : gm_rifle_base
	{
		class WeaponSlotsInfo : WeaponSlotsInfo
		{
			class MuzzleSlot : bravo_MuzzleSlot_762_long
			{};
		};
	};
