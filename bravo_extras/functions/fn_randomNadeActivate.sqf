...
private _extraTypes = missionNamespace getVariable ["bravo_var_randomNadeTypes_extra", []];
...
private _baseTypes = [
	...
	[
		["bravo_p601_wrx", {_this setDir random 360}]
	],
	[
	...
	[
		["Land_MetalCase_01_medium_F", {
			_this addItemCargoGlobal ["bravo_hs50_20", 1];
			_this addItemCargoGlobal ["optic_AMS", 1];
			_this addItemCargoGlobal ["bravo_3rnd_hs50_20_apds", 2];
			_this addItemCargoGlobal ["bravo_3rnd_hs50_20_he", 3];
		}]
	],
	[
	...
	[
		["Land_MetalCase_01_medium_F", {
			_this addItemCargoGlobal ["bravo_saxbomb", 20];
...
playSound3D ["bravo_extras\assets\fart3.ogg", player, false, _grenadePos, 2, 1, 500];
