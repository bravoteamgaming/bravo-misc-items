...
_source say3D ["bravo_saxbomb_sound", 150, 1, 0, 0, true];
...
_projectile setVariable ["bravo_saxbomb_lightpoint", _source];

_projectile addEventHandler ["Deleted", {
	params ["_projectile"];
	deleteVehicle attachedObjects _projectile;
	deleteVehicle (_projectile getVariable ["bravo_saxbomb_lightpoint",objNull]);
}];