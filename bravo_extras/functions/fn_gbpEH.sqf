...
// yaaay!
playSound3D ["bravo_extras\assets\gruntBirthdayParty.ogg", _unit, false, _unit modelToWorldWorld (_unit selectionPosition "Head"), 4, random [0.85, 1, 1.15], 100, 0, true];
