class njt_messenger_display : RscDisplayEmpty
{
	access = 1;
	enableSimulation = 1;
	onLoad = "uiNamespace setVariable ['njt_messenger_displayOpen',true]; true call njt_fnc_messengerLoadList";
	onUnload = "uiNamespace setVariable ['njt_messenger_displayOpen',false];";
	onKeyDown = "if ((_this#1) == 28) then {false call njt_fnc_messengerSendMessage};";
	class controls
	{
		class group : RscControlsGroup
		{
			...
			class controls
			{
				...
				{
					onLoad = "uiNamespace setVariable ['njt_messenger_sendButton', _this select 0]";
					onButtonClick = "false call njt_fnc_messengerSendMessage";
					text = "SEND";
					idc = -1;
				...
				{
					onLoad = "uiNamespace setVariable ['njt_messenger_messageBox', _this select 0]";
				...
				{
					onLoad = "uiNamespace setVariable ['njt_messenger_playerList', _this select 0]";
					shadow = 0;
					font = "PuristaSemiBold";
					colorText[] = {0.2,0.2,0.2,1};
				...
				class innerGroup : RscControlsGroupNoHScrollBars
				{
					...
					class controls
					{
						...
						{
							onLoad = "uiNamespace setVariable ['njt_messenger_messageList', _this select 0]; (_this#0) ctrlEnable false";
							text = "";
							font = "PuristaSemiBold";
							colorText[] = {0.2,0.2,0.2,1};
							shadow = 0;
...
class njt_messenger_displayAnon : njt_messenger_display
{
	onKeyDown = "if ((_this#1) == 28) then {true call njt_fnc_messengerSendMessage};";
	class controls : controls
	{
		class group : group
		{
			...
			class controls : controls
			{
				...
				{
					onButtonClick = "true call njt_fnc_messengerSendMessage";
				};
