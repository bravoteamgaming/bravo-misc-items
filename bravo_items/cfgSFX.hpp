class CfgSFX
{
	...
	{
		sound0[] = { "\bravo_items\assets\radio_muitinkinyakkin.ogg", db-5, 1.0, 100, 1, 20, 30, 50 };
		sounds[] = { "sound0"};
		empty[] = { "", 0, 0, 0, 0, 0, 0, 0 };
	...
	{
		sound0[] = { "\bravo_items\assets\radio_lithiumflower.ogg", db-5, 1.0, 100, 1, 20, 30, 50 };
		sounds[] = { "sound0"};
		empty[] = { "", 0, 0, 0, 0, 0, 0, 0 };
	...
	{
		sound0[] = { "\bravo_items\assets\radio_pumpupthejam.ogg", db-5, 1.0, 100, 1, 20, 30, 50 };
		sounds[] = { "sound0"};
		empty[] = { "", 0, 0, 0, 0, 0, 0, 0 };
