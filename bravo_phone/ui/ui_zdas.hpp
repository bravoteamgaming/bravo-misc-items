class bravo_zdas_display : RscDisplayEmpty
{
	access = 1;
	enableSimulation = 1;
	onLoad = "uiNamespace setVariable ['bravo_zdas_displayOpen',true];";
	onUnload = "uiNamespace setVariable ['bravo_zdas_displayOpen',false];";
	class controls
	{
		class group : RscControlsGroup
		{
			...
			class controls
			{
				...
				{
					onLoad = "uiNamespace setVariable ['bravo_zdas_pingButton', _this select 0]";
					onButtonClick = "0 spawn bravo_fnc_zdasPing";
					text = "PING";
					idc = -1;
				...
				{
					onLoad = "uiNamespace setVariable ['bravo_zdas_readout', _this select 0]";
					font = "LCD14";
					text = "Ready . . .";
