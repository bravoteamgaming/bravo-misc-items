...
private _messageBox = uiNamespace getVariable ["bravo_messenger_messageBox", controlNull];
...
if (_personID != "0") then {
	...
	_messageComposed remoteExec ["bravo_fnc_messengerReceiveMessage", [_personUnit, player]];
};
