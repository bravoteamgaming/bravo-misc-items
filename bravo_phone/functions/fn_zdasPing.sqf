...
private _ctrl = uiNamespace getVariable ["bravo_zdas_readout", controlNull];
private _btnctrl = uiNamespace getVariable ["bravo_zdas_pingButton", controlNull];
...
_phone remoteExec ["bravo_fnc_zdasPingSound"];
