...
private _listControl = uiNamespace getVariable ["bravo_messenger_messageList", controlNull];
private _personControl = uiNamespace getVariable ["bravo_messenger_playerList", controlNull];
private _messages = missionNamespace getVariable ["bravo_var_phoneMessages", []];
...
if ((count _messages) > 0) then {
	...
	(uiNamespace getVariable ["bravo_messenger_messageListGroup", controlNull]) ctrlSetScrollValues [1, 0];
	
};

ctrlSetFocus (uiNamespace getVariable ["bravo_messenger_messageBox", controlNull]);